...
<link href="http://localhost:8080/iSpanCar/Service/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
	type="text/css">
<link
...
<link href="http://localhost:8080/iSpanCar/Service/css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Pages Collapse Menu -->
			<li class="nav-item"><a class="nav-link" href="/serviceInsertServlet.do">
				...
				<div class="container-fluid">
					...
					<form id="signin" action="" method="POST" enctype="multipart/form-data">
						...
						<label>原場副廠：</label><select name="Reseller_nonreseller">
							...
							<option value="1">副廠</option>
						</select><br> <label>保養廠圖片</label><input type="file" name="Carimage"><br>

						<input type="submit" value="提交"
							formaction="<c:url value='/serviceInsertServlet.do'/>"><br>
							<br>
							<br>
<input type="button" value="刪除保養廠" onclick="location.href='/iSpanCar/Service/DeleteService3.jsp'">
<input type="button" value="修改保養廠" onclick="location.href='/iSpanCar/Service/UpdateService3.jsp'">
<input type="button" value="查詢保養廠" onclick="location.href='/iSpanCar/Service/SelectService3.jsp'"><br>
					</form>
				</div>
				<!-- /.container-fluid -->
	...
	<script src="http://localhost:8080/iSpanCar/Service/vendor/jquery/jquery.min.js"></script>
	<script src="http://localhost:8080/iSpanCar/Service/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

	<!-- Core plugin JavaScript-->
	<script src="http://localhost:8080/iSpanCar/Service/vendor/jquery-easing/jquery.easing.min.js"></script>

	<!-- Custom scripts for all pages-->
	<script src="http://localhost:8080/iSpanCar/Service/js/sb-admin-2.min.js"></script>
