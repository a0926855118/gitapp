...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Pages Collapse Menu -->
			<li class="nav-item"><a class="nav-link" href="'/serviceSelectServlet.do'/>">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-4 text-gray-800">更改保養廠資訊</h1>
...
<input type="submit"  value="更改" formaction="<c:url value='/serviceUpdateServlet.do'/>"><br>
	<br>
							<br>
<input type="button" value="新增保養廠" onclick="location.href='/iSpanCar/Service/signin2.jsp'">
